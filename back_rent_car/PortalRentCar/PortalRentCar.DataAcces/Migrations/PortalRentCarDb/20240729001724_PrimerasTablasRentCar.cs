...
{
    /// <inheritdoc />
    public partial class PrimerasTablasRentCar : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2024, 7, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sedan" },
                    { 2, true, new DateTime(2024, 7, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "HashBack" },
                    { 3, true, new DateTime(2024, 7, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "MiniVan" }
                });
